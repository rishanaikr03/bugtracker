                            ...
                            <TableBody>
                                {display.map((row) => (
                                    ...
                                    >
                                        ...
                                        {row.status == "pending" ? <TableCell align="center"><Button variant="contained" color="error">Pending</Button></TableCell> : <TableCell align="center"><Button variant="contained" color="success">{row.sd_id.name}</Button></TableCell>}
